        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-[#1C2526]/50 border border-[#ADD8E6]/30 rounded-xl p-8 backdrop-blur-sm">
              ...
              <p className="mb-4 text-[#E0F6FF]">
                v1 of Our flagship AI engagement bot (<span className="text-[#ADD8E6]">@aicexbt</span>) proved its power, delivering over <span className="text-[#87CEEB] font-bold">60,000 impressions</span> during development and earning some Kaito Yaps. Sadly, with the volume of KOLs it was targetting and the frequency of updates being applied to the X page, the account was suspended. We have subsequently released V2, a market intelligence bot that posts regular insights and can be called upon like aixbt.
              </p>
              <p className="mb-4 text-[#E0F6FF]">
